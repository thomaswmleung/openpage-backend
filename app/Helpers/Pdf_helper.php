...
//                                exit();
                                ...
                                $fpdf->Rect($optionsXInitial, $optionsYInitial - 3, 170, $estimatedY - $optionsYInitial + 5, 'F');
...
//                                exit();
                                ...
                                if (isset($question['type']) AND
                                        $question['type'] == "match_phrase_1") {
